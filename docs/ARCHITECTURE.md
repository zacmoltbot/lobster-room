...
| P1.3 | Internal token / jargon 全面 suppress | **執行中** | subagent / discord 等 |
| P1.4 | Completed command 最低資訊量 | 待執行 | 不能 alone 無意義結束 |
| P1.5 | Raw command 不泄漏到 what | 待執行 | aggregation 時 command 不進 what |
